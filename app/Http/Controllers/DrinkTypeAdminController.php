...
class DrinkTypeAdminController extends Controller
{
   ...
   /** 
    ...
    public function index()
    {
        ...
        return view('drinktypeadmin.index')->with('drinktype', $drinktype);
    }
    ...
    {
        return view('drinktypeadmin.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/drinktypeadmin')->with('success', 'DrinkType Created');
    }
    ...
    public function show($id)
    {
        ...
        return view('drinktypeadmin.show')->with('drinktype', $drinktype);
    }
    ...
    public function edit($id)
    {
        ...
        if (!isset($drinktype)){
            return redirect('/drinktypeadmin')->with('error', 'No DrinkType Found');
        }

        return view('drinktypeadmin.edit')->with('drinktype', $drinktype);
    }
    ...
    public function update(Request $request, $id)
    {
	   ...
	   //Make thumbnails
        ...
        return redirect('/drinktypeadmin')->with('success', 'DrinkType Updated');
    }
    ...
    {
        $drinktype = DrinkType::find($id);
        $drink = Drink::where('drinktype_id' , '=' , $id)->delete();
        ...
        $drinktype->delete();
        return redirect('/drinktypeadmin')->with('success', 'DrinkType Removed');
    }
}
