...
class DrinkRestaurantController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('drinkrestaurant.index')->with('drink' , $drink)->with('assigneddrinks' , $assigneddrinks);
    }
    ...
    public function assigndrinkrestaurant($drinkid)
    {
        $restaurant_id = Session::get('restaurant_id'); 
