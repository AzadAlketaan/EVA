...
class FoodTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('foodtype.index')->with('foodtype', $foodtype);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/foodtype')->with('success', 'FoodType Created');
    }
    ...
    public function show($id)
    {
        ...
        $food = Food::where('foodtype_id' , '=' , $id)->get();

        return view('foodtype.show')->with('foodtype', $foodtype)->with('food', $food);
    }
    ...
    public function edit($id)
    {
        ...
        if (!isset($foodtype)){
            return redirect('/foodtype')->with('error', 'No FoodType Found');
        }

        return view('foodtype.edit')->with('foodtype', $foodtype);
    }
    ...
    public function update(Request $request, $id)
    {
	   ...
	   //Make thumbnails
        ...
        return redirect('/foodtype')->with('success', 'FoodType Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $foodtype->delete();
        return redirect('/foodtype')->with('success', 'FoodType Removed');
    }
}
