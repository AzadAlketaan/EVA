...
class RestaurantAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('restaurantadmin.index')->with('restaurant', $restaurant);
    }
    ...
    public function create()
    {
        ...
        return view('restaurantadmin.create')->with('restauranttype', $restauranttype);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/restaurantadmin')->with('success', 'Restaurant Created');
    }
    ...
    public function show($id)
    {
        ...
        return view('restaurantadmin.show')->with('user', $user)->with('userrestaurant', $userrestaurant)->with('drink', $drink)->with('food', $food)->with('foodrestaurant', $foodrestaurant)->with('drinkrestaurant', $drinkrestaurant)->with('restaurant', $restaurant)->with('restauranttype', $restauranttype);
    }
    ...
    public function edit($id)
    {
        ...
        return view('restaurantadmin.edit')->with('address', $address)->with('restaurant', $restaurant)->with('restauranttype', $restauranttype);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/restaurantadmin')->with('success', 'Restaurant Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/restaurantadmin')->with('success', 'Restaurant Removed');
    }
}
