...
class FoodRestaurantAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('foodrestaurantadmin.index')->with('food' , $food)->with('assignedfoods' , $assignedfoods);
    } 
    ...
    public function assignfoodrestaurantadmin($foodid)
    {
        $restaurant_id = Session::get('restaurant_id'); 
